            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <header className="mb-12">
                    ...
                    >
                        ...
                        />
                        <h1 className="text-4xl font-black tracking-tight text-slate-900">Support History</h1>
                        <p className="text-slate-500 mt-2 font-medium">Overview of your submitted service requests</p>
                    </motion.div>
                </header>
                        ...
                        >
                            {complaints.map((item) => (
                                <motion.div
                                    ...
                                    className="group relative flex flex-col bg-white border border-slate-200 rounded-2xl p-6 hover:border-blue-300 transition-all duration-300 shadow-sm"
                                >
                                    {/* Status Indicator */}
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-6">
                                        ...
                                        <TagBadge icon={<Tag className="w-3 h-3" />} label={item.category?.name || 'Issue'} />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-slate-50">
                                        ...
                                        <motion.button
                                            whileHover={{ x: 3 }}
                                            className="text-blue-600 hover:text-blue-700 font-bold text-xs flex items-center gap-0.5"
                                        >
                                            View Details
...
const TagBadge = ({ icon, label }) => (
    <div className="flex items-center gap-1.5 px-2 py-1 bg-slate-50 rounded-lg text-[11px] font-bold text-slate-500 border border-slate-100">
        {icon}
        {label}
    </div>
);
...
const getStatusColor = (status) => {
    switch (status) {
        ...
        case 'In Progress': return 'text-blue-600 bg-blue-50/50 border-blue-100';
...
const EmptyState = () => (
    ...
    >
        ...
        <h2 className="text-xl font-bold text-slate-900">Workspace is quiet</h2>
        <p className="text-slate-400 text-sm mt-1">No active complaints were found for your account.</p>
    </motion.div>
);
