                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500">
                                    Complaints assigned to you (Operator: {registerNo})
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {['all', 'pending', 'in progress', 'assigned', 'resolved', 'rejected'].map((status) => (
                                            <button
                                                key={status}
            ...
            <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                {loading ? (
                    <div className="bg-white rounded-xl border border-slate-200 p-16 text-center">
                        ...
                        <p className="text-slate-600 font-medium">Loading assigned complaints...</p>
                                                                                        ...
                                                                                        {item.assignedTo && (
                                                                                            <div>
                                                                                                ...
                                                                                                {item.assignedTo.email && (
                                                                                                    <p className="text-xs text-slate-500 mt-1">{item.assignedTo.email}</p>
                                                                                                )}
                                                                                            </div>
                                                                                        )}
                                                                                    </div>
